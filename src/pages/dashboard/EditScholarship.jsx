...
const EditScholarship = () => {
    ...
    const fetchScholarship = async () => {
      try {
        ...
        Object.keys(res.data).forEach((key) => {
          if (key in res.data) setValue(key, res.data[key]);
        });
        ...
        Swal.fire({
          title: "Error",
          text: "Failed to fetch scholarship data",
          icon: "error",
        });
        setLoading(false);
      }
  ...
  const onSubmit = async (data) => {
    try {
      ...
      await axiosSecure.patch(`/update-scholarship/${id}`, data);
      ...
      Swal.fire({
        title: "Failed!",
        text: "Only Admin can update scholarships",
        icon: "error",
      });
    }
  };
  ...
  return (
    <div className="min-h-screen bg-base-200 p-6 flex justify-center items-center">
      <div className="w-full max-w-4xl bg-base-100 shadow-xl rounded-2xl p-8">
        <h2 className="text-3xl font-bold text-center mb-8">Edit Scholarship</h2>
